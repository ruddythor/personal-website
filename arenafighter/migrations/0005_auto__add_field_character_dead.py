...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.dead'
        db.add_column(u'arenafighter_character', 'dead',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.dead'
        db.delete_column(u'arenafighter_character', 'dead')
    ...
    models = {
        ...
        'arenafighter.enemy': {
            ...
            'gold': ('django.db.models.fields.IntegerField', [], {'default': '20'}),
