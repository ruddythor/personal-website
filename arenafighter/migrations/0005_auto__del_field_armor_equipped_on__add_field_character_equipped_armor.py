...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Character.equipped_armor'
        db.add_column(u'arenafighter_character', 'equipped_armor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='equipped_on', null=True, blank=True, to=orm['arenafighter.Armor']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'arenafighter_armor', 'equipped_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='equipped_armor', null=True, to=orm['arenafighter.Character'], blank=True),
                      keep_default=False)

        # Deleting field 'Character.equipped_armor'
        db.delete_column(u'arenafighter_character', 'equipped_armor_id')
