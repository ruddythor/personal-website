...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryItem.equipped_on'
        db.add_column(u'arenafighter_inventoryitem', 'equipped_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='equipped_items', null=True, blank=True, to=orm['arenafighter.Character']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'InventoryItem.equipped_on'
        db.delete_column(u'arenafighter_inventoryitem', 'equipped_on_id')
    ...
    models = {
        ...
        'arenafighter.inventoryitem': {
            ...
            'buy_value': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'equipped_on': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'equipped_items'", 'null': 'True', 'blank': 'True', 'to': "orm['arenafighter.Character']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
