...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.fights_won'
        db.add_column(u'arenafighter_player', 'fights_won',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Player.fights_lost'
        db.add_column(u'arenafighter_player', 'fights_lost',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.fights_won'
        db.delete_column(u'arenafighter_player', 'fights_won')

        # Deleting field 'Player.fights_lost'
        db.delete_column(u'arenafighter_player', 'fights_lost')
