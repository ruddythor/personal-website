...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'arenafighter_character', (
            ...
            ('hpmax', self.gf('django.db.models.fields.IntegerField')(default=55)),
        ...
        # Changing field 'Profile.current_character'
        db.alter_column(u'arenafighter_profile', 'current_character_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['arenafighter.Character']))

        # Changing field 'Inventory.owner'
        db.alter_column(u'arenafighter_inventory', 'owner_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['arenafighter.Character'], unique=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'arenafighter_player', (
            ('base_defense', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('gold', self.gf('django.db.models.fields.IntegerField')(default=50)),
            ('hpmax', self.gf('django.db.models.fields.IntegerField')(default=45)),
            ('renown', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('xp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(default='The Stranger')),
        ...
        # Changing field 'Profile.current_character'
        db.alter_column(u'arenafighter_profile', 'current_character_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['arenafighter.Player']))

        # Changing field 'Inventory.owner'
        db.alter_column(u'arenafighter_inventory', 'owner_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['arenafighter.Player'], unique=True))
    ...
    models = {
        ...
        'arenafighter.enemy': {
            ...
            'gold': ('django.db.models.fields.IntegerField', [], {'default': '16'}),
            'hpmax': ('django.db.models.fields.IntegerField', [], {'default': '66'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'arenafighter.inventory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'inventory'", 'null': 'True', 'default': 'None', 'to': "orm['arenafighter.Character']", 'blank': 'True', 'unique': 'True'}),
