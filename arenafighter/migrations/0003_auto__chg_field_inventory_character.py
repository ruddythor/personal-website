...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.character'
        db.alter_column(u'arenafighter_inventory', 'character_id', self.gf('django.db.models.fields.related.OneToOneField')(default=3, unique=True, to=orm['arenafighter.Character']))

    def backwards(self, orm):

        # Changing field 'Inventory.character'
        db.alter_column(u'arenafighter_inventory', 'character_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['arenafighter.Character'], unique=True))
    ...
    models = {
        ...
        'arenafighter.character': {
            ...
            'hpmax': ('django.db.models.fields.IntegerField', [], {'default': '63'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'arenafighter.enemy': {
            ...
            'hpmax': ('django.db.models.fields.IntegerField', [], {'default': '49'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
