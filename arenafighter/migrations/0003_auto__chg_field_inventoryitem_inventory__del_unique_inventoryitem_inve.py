...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'InventoryItem', fields ['inventory']
        db.delete_unique(u'arenafighter_inventoryitem', ['inventory_id'])


        # Changing field 'InventoryItem.inventory'
        db.alter_column(u'arenafighter_inventoryitem', 'inventory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['arenafighter.Inventory']))

    def backwards(self, orm):

        # Changing field 'InventoryItem.inventory'
        db.alter_column(u'arenafighter_inventoryitem', 'inventory_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['arenafighter.Inventory']))
        # Adding unique constraint on 'InventoryItem', fields ['inventory']
        db.create_unique(u'arenafighter_inventoryitem', ['inventory_id'])
    ...
    models = {
        ...
        'arenafighter.enemy': {
            ...
            'gold': ('django.db.models.fields.IntegerField', [], {'default': '13'}),
