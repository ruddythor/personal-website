...
urlpatterns = patterns('',
    ...
    url(r'^shop_item/(.+)$', 'arenafighter.views.store.item_detail', {'store': False}, name='shop_item'),
    url(r'^shop_weapon/(.+)$', 'arenafighter.views.store.weapon_detail', {'store': False}, name='shop_weapon'),
    url(r'^shop_armor/(.+)$', 'arenafighter.views.store.armor_detail', {'store': False}, name='shop_armor'),
    url(r'^item/(.+)$', 'arenafighter.views.store.item_detail', name='item_info'),
    url(r'^weapon/(.+)$', 'arenafighter.views.store.weapon_detail', name='weapon_info'),
    url(r'^armor/(.+)$', 'arenafighter.views.store.armor_detail', name='armor_info'),
